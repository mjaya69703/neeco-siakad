...
@section('custom-css')
    ...
    <style>
        ...
        .btn-purple { background-color: #7c3aed; color: white; border-color: #7c3aed; }
        .btn-purple:hover { background-color: #6d28d9; border-color: #6d28d9; }
        .btn-orange { background-color: #f56565; color: white; border-color: #f56565; }
        .btn-orange:hover { background-color: #e53e3e; border-color: #e53e3e; }
        .btn-teal { background-color: #38b2ac; color: white; border-color: #38b2ac; }
        .btn-teal:hover { background-color: #2c7a7b; border-color: #2c7a7b; }
                                ...
                                @forelse($sample_data['agamas'] as $agama)
                                    <div class="reference-item">
                                        ...
                                        <span class="badge bg-light text-dark">
                                            {{ method_exists($agama, 'users') ? $agama->users->count() : 0 }} pengguna
                                        </span>
                                    </div>
                                @empty
                            ...
                            <div class="card-body p-0">
                                @forelse($sample_data['golongan_darahs'] as $gd)
                                    <div class="reference-item">
                                        <span>{{ $gd->name }}</span>
                                        <span class="badge bg-light text-dark">
                                            {{ method_exists($gd, 'users') ? $gd->users->count() : 0 }} pengguna
                                        </span>
                                    </div>
                                @empty
                                    <div class="p-3 text-center text-muted">
                            ...
                            <div class="card-body p-0">
                                @forelse($sample_data['jenis_kelamins'] as $jk)
                                    <div class="reference-item">
                                        <span>{{ $jk->name }}</span>
                                        <span class="badge bg-light text-dark">
                                            {{ method_exists($jk, 'users') ? $jk->users->count() : 0 }} pengguna
                                        </span>
                                    </div>
                                @empty
                                    <div class="p-3 text-center text-muted">
                            ...
                            <div class="card-body p-0">
                                @forelse($sample_data['kewarganegaraans'] as $kw)
                                    <div class="reference-item">
                                        <span>{{ $kw->name }}</span>
                                        <span class="badge bg-light text-dark">
                                            {{ method_exists($kw, 'users') ? $kw->users->count() : 0 }} pengguna
                                        </span>
                                    </div>
                                @empty
                                    <div class="p-3 text-center text-muted">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card reference-grid">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-warning badge-count">{{ $sample_data['jabatans']->count() }}</span>
                            </div>
                            <div class="card-body p-0">
                                @forelse($sample_data['jabatans'] as $jabatan)
                                    <div class="reference-item">
                                        <div>
                                            <span class="fw-bold">{{ $jabatan->name }}</span>
                                            <div class="text-muted small">{{ $jabatan->divisi ?? 'Divisi tidak tersedia' }}</div>
                                        </div>
                                    </div>
                                @empty
                                    <div class="p-3 text-center text-muted">
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card reference-grid">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge bg-purple badge-count">{{ $sample_data['semesters']->count() }}</span>
                            </div>
                            <div class="card-body p-0">
                                @forelse($sample_data['semesters']->take(8) as $semester)
                                    <div class="reference-item">
                                ...
                                @endforelse
                                @if($sample_data['semesters']->count() > 8)
                                    <div class="p-2 text-center">
                                        <small class="text-muted">dan {{ $sample_data['semesters']->count() - 8 }} semester lainnya...</small>
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <a href="{{ url('/referensi/status-mahasiswa') }}" class="management-btn btn btn-orange w-100">
                                    <i class="fas fa-user-graduate me-2"></i>Kelola Status Mahasiswa
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ url('/referensi/role') }}" class="management-btn btn btn-teal w-100">
                                    <i class="fas fa-users-cog me-2"></i>Kelola Role
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ url('/referensi/alamat') }}" class="management-btn btn btn-secondary w-100">
                            ...
                            <div class="col-md-4">
                                <a href="{{ url('/referensi/pendidikan') }}" class="management-btn btn btn-light w-100">
                                    <i class="fas fa-graduation-cap me-2"></i>Data Pendidikan
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="{{ url('/referensi/keluarga') }}" class="management-btn btn btn-outline-primary w-100">
