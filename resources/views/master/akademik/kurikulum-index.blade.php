                ...
                buttons: [
                    ...
                    },
                    {
                        ...
                        customize: function(doc) {
                            ...
                            doc.content[0].text = 'Data Kurikulum';
                    ...
                    },
                    {
                        ...
                        customize: function(win) {
                            $(win.document.body)
                                .css('font-size', '10pt')
                                .prepend('<div style="text-align:center; margin-bottom: 20px;"><h3>Data Kurikulum</h3><p>Dicetak pada: ' + new Date().toLocaleDateString('id-ID') + '</p></div>');
