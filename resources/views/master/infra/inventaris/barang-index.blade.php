        ...
        <div class="col-lg-8 col-12 mb-2">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        @if($is_trash)
                            <a href="{{ route('inventaris.barang-index') }}" class="btn btn-sm btn-secondary me-2">
                                <i class="fas fa-arrow-left me-2"></i>Kembali ke Daftar Utama
                            </a>
                        @else
                            <a href="{{ route('inventaris.barang-trash') }}" class="btn btn-sm btn-warning me-2">
                            ...
                            <tbody>
                                @foreach ($barangs as $key => $item)
                                    <tr>
                                        ...
                                        <td data-label="Aksi">
                                            @if($is_trash)
                                                <form action="{{ route('inventaris.barang-restore', $item->id) }}" method="POST" class="d-inline restore-form">
                                                    @csrf
                                            ...
                                            @else
                                                ...
                                                <form action="{{ route('inventaris.barang-destroy', $item->id) }}" method="POST" class="d-inline delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="editModalLabel{{ $item->id }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('inventaris.barang-update', $item->id) }}" method="post">
                                                        @csrf
                                                        @method('PATCH')
